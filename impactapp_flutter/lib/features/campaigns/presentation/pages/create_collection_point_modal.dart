...
class CreateCollectionPointModal extends StatefulWidget {
  ...
  @override
  State<CreateCollectionPointModal> createState() => _CreateCollectionPointModalState();
}

class _CreateCollectionPointModalState extends State<CreateCollectionPointModal> {
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            border: Border.all(color: Colors.black.withValues(alpha: 0.1), width: 1.18025),
                              ...
                              onPressed: () {
                                ...
                                Navigator.of(context).pop(
                                  CollectionPointDraft(
                                    ...
                                    articulosAceptados: _articulosCtrl.text.trim(),
                                  ),
                                );
                              },
                          ...
                          Expanded(
                            child: OutlinedButton(
                              ...
                              style: OutlinedButton.styleFrom(
                                minimumSize: const Size.fromHeight(32),
                                side: BorderSide(color: Colors.black.withValues(alpha: 0.1), width: 1.18025),
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
